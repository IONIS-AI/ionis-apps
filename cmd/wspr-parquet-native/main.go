...
func main() {
	...
	reportDir := flag.String("report-dir", "", "Report output directory (default: $IONIS_REPORT_DIR/reports-parquet-native)")
	...
	if v, err := common.ResolveReportDir(*reportDir, "reports-parquet-native"); err != nil {
		log.Fatal(err)
	} else {
		*reportDir = v
	}
